...
class FrameUI ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"桂花转稿工具", pos = wx.DefaultPosition, size = wx.Size( 900,600 ), style = wx.CAPTION|wx.CLOSE_BOX|wx.MINIMIZE_BOX|wx.TAB_TRAVERSAL )
		...
		self.m_staticText5 = wx.StaticText( self.set_panel, wx.ID_ANY, u"转稿的网址\n（一行一个\n最多10个）", wx.DefaultPosition, wx.DefaultSize, 0 )
